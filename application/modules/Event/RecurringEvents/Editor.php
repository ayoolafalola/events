 ...
 *
 * @category   PageCarton
 * @package    Event_RecurringEvents_Editor
...
class Event_RecurringEvents_Editor extends Event_RecurringEvents_Abstract
{
    ...
    {    
		...
		{ 
			...
			$this->createForm( 'Save', 'Edit recurrent event', $data );
